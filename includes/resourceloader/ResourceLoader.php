...
class ResourceLoader {
	...
	protected function sendResponseHeaders( ResourceLoaderContext $context, $mtime, $errors ) {
		...
		if ( false && $context->getDebug() ) {//@jbernal
	...
	public static function makeLoaderURL( $modules, $lang, $skin, $user = null, $version = null, $debug = false, $only = null,
		...
		//$var = wfExpandUrl( wfAppendQuery( $wgLoadScript, $query ) . '&*', PROTO_RELATIVE );//@jbernal
		// print $var."<p />";//@jbernal
