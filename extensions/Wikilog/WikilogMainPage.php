	...
	implements WikilogCustomAction
{
	...
	public function view() {
		...
		$body = '<div id="blogSearch">
		<form action="index.php?title=Special%3ASearch&amp;profile=advanced&amp;fulltext=Search&amp;ns100=1&amp;ns101=1&amp;redirs=1&amp;profile=advanced">
			<input name="search" value="" id="blogSearchInput" autocomplete="off" placeholder="Search Blog and Case Reviews" />
			<button name="button" title="Search the blog for this text" id="blogSearchButton"><img src="/skins/vector/images/search-ltr.png?303" alt="Search" /></button>
			<input type="hidden" value="1" name="ns100" />
		</form>
		</div>';
