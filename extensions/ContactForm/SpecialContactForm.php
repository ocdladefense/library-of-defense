...
class SpecialContactForm extends SpecialPage {
	private $htmlFile = 'ContactForm.tpl.php';
	...
	function getContactPage()
	{
		...
		$output->addStyle('/extensions/ContactForm/contact.css?v=0.1', 'all');
		$output->addScriptFile('/extensions/ContactForm/form.js');
	}
