...
# This file was automatically generated by the MediaWiki 1.18.2 installer. If you make manual changes, please keep track in case you need to recreate them later.
# See includes/DefaultSettings.php for all configurable settings and their default values, but don't forget to make changes in _this_file, not there.
# Further documentation for configuration settings may be found at: http://www.mediawiki.org/wiki/Manual:Configuration_settings
...
// "$wgWhiteListRead" sets the user permissions for all pages in the array to read.
